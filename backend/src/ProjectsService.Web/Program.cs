...
using ProjectsService.Core;
using ProjectsService.Infrastructure.Postgres;
using Scalar.AspNetCore;
using Shared.Authorization;
using CoreRegistration = ProjectsService.Core.Registration;

namespace ProjectsService.Web;
...
public static class Program
{
    ...
    private static void ApplyDevelopmentMigrations(WebApplication app)
    {
        ...
        var dbContext = scope.ServiceProvider.GetRequiredService<ProjectsServiceDbContext>();
